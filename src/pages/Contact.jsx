    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
            ...
            <p className='text-gray-500'>54709 Willms Station <br /> waris coloney, USA</p>
            <p  className='text-gray-500'>Tel: +923047602914 <br />Email: hamzamalhi127@gmail.com</p>
